# PODNAME: MooX::Options::Manual::Option
...
See also L<Man parameters|MooX::Options::Manual::Man> for more examples to build a nice man page.
...
You need to understand that everything is explicit here. Check L<MooX::Options::Manual::Philosophy> to understand.
