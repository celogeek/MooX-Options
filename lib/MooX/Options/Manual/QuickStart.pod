# PODNAME: MooX::Options::Manual::QuickStart
# ABSTRACT: Fast and simple examples

=head1 DESCRIPTION

This is quick examples to start creating your commandline tools.

=head1 QUICK START

=head2 DISPLAY A FILE

You can quickly create a basic command line tool, using inline package to capture the option you need.
...
=item * Run it
  ...
  myTool.pl --show_this_file=myDoc
  myTool.pl --show-this-file=myDoc
  myTool.pl --show=myDoc
  myTool.pl -f=myDoc
  myTool.pl -f myDoc
...
If you miss the required params, L<MooX::Options> explain the error, and show you the help message :
  ...
  USAGE: myTool.pl [-fh] [long options...]
...
You can create an array for files to display. A cool feature is the "autosplit" parameter.
...
To display myDoc1 and myDoc2 :
  ...
  myTool.pl --show_this_files=myDoc1 --show_this_files=myDoc2
  myTool.pl --show_this_files=myDoc1,myDoc2
